    ...
    <body>
        ...
        <table>
            ...
            <?php if(@$_SESSION['cart']==true && $_SESSION["status"]=="Customer"){ ?>
                <tr>
                    <td colspan="7" class="td-full">
                        <select class="form-control" name="pembayaran" required>
                            <option value="">Pilih Metode Pembayaran</option>
                            <option value="DANA">DANA - 08126258654</option>
                            <option value="BRI">TPK A3 - 123456877</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td colspan="7" class="td-full"><button type="submit" class="tambah">Check Out</button></td>
                </tr>
            <?php } ?>
