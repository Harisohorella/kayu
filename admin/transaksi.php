...
<html>
    ...
    <body>
        ...
        <table>
            <th>NO</th><th>Tanggal Transaksi</th><th>Nama Produk</th><th>Total Harga</th><th>Pembayaran</th><th>Status</th><th>Aksi</th>
            <?php
                include "koneksi.php";
                ...
                while($dt_histori=mysqli_fetch_array($qry_histori)){ 
                    ...
                    if(mysqli_num_rows($qry_cek_bayar)>0){ 
                        ...
                        $button="<a class='btn' href='bayar.php?id_transaksi=".$dt_histori['id_transaksi']."'><i class='las la-cash-register'></i></a>";
                    }
            ?>
            <tr>
                <td><?=$no?></td><td><?=$dt_histori['tgl_transaksi']?></td><td><?=$produk_dibeli?></td><td><?=$subtotal?></td><td><?=$dt_histori['pembayaran']?></td><td><?=$status_transaksi?></td><td><?=$button?></td>
            </tr>
            <?php } ?>
        </table>
    </body>
